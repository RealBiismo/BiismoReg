...
function renderEntitlements(data) {
  ...
  if (data.plusActive) {
    ...
    plusPlanButton.textContent = "Manage BIISMO REG+";
    ...
    plusPlanNote.textContent = data.subscriptionPeriodEnd
      ...
      : "BIISMO REG+ is active on this account.";
  } else {
    plusPlanCard.classList.remove("is-active");
    plusPlanButton.textContent = "Start BIISMO REG+";
...
async function initializeStore() {
  ...
  if (plusResult === "success") setPurchaseStatus("BIISMO REG+ payment received. Activating your monthly benefits…", "success");
  else if (plusResult === "cancelled") setPurchaseStatus("BIISMO REG+ checkout cancelled. You have not been charged.");
